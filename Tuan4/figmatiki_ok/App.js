    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View>
          ...
          <Text style={styles.textLineThrough}>141.800đ</Text>
          <View
            ...
            <View
              ...
              <TouchableOpacity
                style={{ backgroundColor: '#808080', width: 15, height: 15, justifyContent: 'center' }}
      ...
      <View
        style={{ height: 15, width: '100%', backgroundColor: 'gray' }}></View>
      <View
        style={{
          flexDirection: 'row',
          height: 40,
      ...
      <View
        style={{ height: 100, width: '100%', backgroundColor: 'gray' }}></View>
      <View
        style={{
          flexDirection: 'row',
          height: 40,
